:imagesdir: images
:meta-description: Eventing is a new service available in Couchbase Server. The Cincinnati Reds are interested in using this feature to more quickly serve their VIP customers.
:title: Eventing: Notification with Couchbase Functions
:slug: Eventing-Notification-Couchbase-Functions
:focus-keyword: eventing
:categories: Couchbase Server, .NET
:tags: Couchbase Server, .NET, eventing, functions
:heroimage: 111-hero-cincinnati-reds-vip.jpg from https://www.nationalmuseum.af.mil/Upcoming/Photos/igphoto/2001339275/mediaid/2438863/
...
image:11102-function-sending-text-message.gif[Eventing demonstration using SMS]
