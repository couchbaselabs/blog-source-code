...
5. I installed Couchbase Server 5.5. I setup the link:https://developer.couchbase.com/documentation/server/5.5/settings/install-sample-buckets.html[travel-sample bucket]. I link:https://developer.couchbase.com/documentation/server/5.5/security/security-rbac-for-admins-and-apps.html[created a user] "matt" with full access to that bucket.
