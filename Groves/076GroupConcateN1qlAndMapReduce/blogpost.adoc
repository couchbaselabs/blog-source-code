...
We'll select the doctorId from each patient document, and the key to the patient document. Apply `ARRAY_AGG` to the patient document ID, and group the results by the doctorId.
