:imagesdir: images
:meta-description: Scaling a Couchbase Server cluster on Azure is as easy as using a slider. This post walks you through it from the beginning.
:title: Scaling Couchbase Server on Azure
:slug: Scaling-Couchbase-Server-Azure
:focus-keyword: scaling
:categories: Couchbase Server, Couchbase Architecture
