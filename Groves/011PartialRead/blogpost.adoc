...
In this example, the document is very small. In your system, it could be much larger. But maybe you only want the username. You can pull back just the username, using the sub-document API:
