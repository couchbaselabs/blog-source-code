...
Make sure to read {link:asp-net-core-crud-with-nosql-part-1}[part 1 of this series], which covers setup and configuration of your ASP.NET Core "wishlist" project.
