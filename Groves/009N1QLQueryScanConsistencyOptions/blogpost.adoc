...
= N1QL Query Scan Consistency options
...
You can link:https://github.com/couchbaselabs/blog-source-code/tree/master/Groves/009N1QLQueryScanConsistencyOptions[download the complete source code for this blog post on Github].