...
_Note: To keep this post simple, I omitted some of the repository details, and test setup. You can view all of this in the GitHub repository._

== Integration Test with Visual Studio Live Unit Testing

Visual Studio Live Unit Testing will happily run this unit test. You may not want these types of tests to be running the background automatically because:
...
To exclude tests from Live Unit Testing, you can simply right-click on the test file.
...
By all means, if you know of a better way to achieve this, I want to know about. Please leave a comment below or ping me on Twitter @mgroves.
