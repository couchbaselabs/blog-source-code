...
****
Using wait-for-it *is optional*, but when you're right in the middle of development, this may save you some headaches. (Note that I did not include wait-for-it.sh in my link://[sample GitHub repo]).
****
